...
"valente traiu vendeu servidor pra randola e vazou imortaloo e o santos sao os novos donos\n"
"Eu tava pensando em fazer tipo a do Fortnite ja q a história do Fortnite gira em torno do ponto zero e meio Rick Morty, eu tbm queria saber se conta a partir da beta ou a partir da temporada 1, ent mn pra eu fazer a história eu usei como fonte a historia da imortal city, ent o imortaloo gpt é o mais inteligente da imortal city e um dos experimentos dele levou a criar um vírus tipo o simbionte do venom e esse vírus tem vida própria e fez com q ele escapasse do laboratório infectando as pessoas da imortal city, assim começando a temporada 1, a temporada 1 a gente controla o imortaloo gpt tentando sobreviver ao apocalipse, no final da temporada o vírus finalmente conseguiria infectar o imortaloo gpt ent o vírus usa a inteligência dele para criar outros portais para outros universos para infectar mais pessoas, mas uns dos portais levou a Marvel ent o Reed Richards conseguiria criar uma cura, só q quando o vírus percebeu q tinham criado uma cura, ele fechou  os portais e se auto destruiu, o vírus dobrava os atributos das pessoas incluindo a inteligência ent o imortaloo gpt não saberia criar o portal dnv pra fazer os heróis voltarem pra seu universo fazendo assim começar a temporada 2 dos heróis, e na temporada 2 nós controlariamos nós msm tentando virar heróis, eu não pensei na temporada 3 ainda pq tô esperando a sua aprovaçãoNo final da temporada 2 o imortaloo gpt finalmente descobre como criar portais mas isso tbm abriria um portal pra outros universos, só lembrando q os portais não tem tamanho, são de vários tamanhos diferentes, e o imortaloo gpt descobriu como controla o tamanho dos portais só q ele teria que controlar todos os portais enquanto os heróis voltavam pro universo deles, enquanto os heróis voltavam, o imortaloo gpt sem querer encostou no botão errado fazendo um portal triplicar de tamanho(obs:esse portal ficava embaixo da imortal city) fazendo abrir um buraco debaixo da imortal city, fazendo q todos caíssem dentro desse portal oq levou todos para o universo de one piece(o portal não engole casas e prédios apenas pessoas e objetos) fazendo assim começar a temporada 3, e nessa temporada a gente iria controlar nós mesmos ou o luffy(oq vc preferir daí) tentando virar marinheiro ou pirata\n"
"phineas/ricochete é um cara muito foda que o enaldo adimira muito ele tinha sumido ele é bem antigo no server e comprou vip\n"
)

# ================= READY =================
@bot.event
async def on_ready():
    await bot.change_presence(activity=discord.Game(name="outer wilds🌌"))
